...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        img: Image,hints: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.CalendarExtraction> {
          try {
          ...
          const __stream__ = this.stream.ExtractCalendar(
          img,hints,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.CalendarExtraction
            } catch (error) {
            ...
            img: Image,hints: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CalendarExtraction, types.CalendarExtraction>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}), env: { ...(this.bamlOptions.env || {}), ...(__baml_options__?.env || {}) } }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ExtractCalendar", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CalendarExtraction, types.CalendarExtraction>(
                  __raw__,
                  (a): partial_types.CalendarExtraction => a,
                  (a): types.CalendarExtraction => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
