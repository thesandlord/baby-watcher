...
export default class TypeBuilder {
    ...
    BusySlot: ClassViewer<'BusySlot', "start" | "end" | "title" | "durationMinutes">;
    
    CalendarExtraction: ClassViewer<'CalendarExtraction', "isWeekView" | "date" | "weekStart" | "busySlots" | "days" | "needsDateConfirmation" | "confidence">;
    
    DayAvailability: ClassViewer<'DayAvailability', "date" | "busySlots" | "confidence">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "BusySlot","CalendarExtraction","DayAvailability",
          ]),
          enums: new Set([
            "Confidence",
          ]),
        ...
        this.BusySlot = this.tb.classViewer("BusySlot", [
          "start","end","title","durationMinutes",
        ]);
        
        this.CalendarExtraction = this.tb.classViewer("CalendarExtraction", [
          "isWeekView","date","weekStart","busySlots","days","needsDateConfirmation","confidence",
        ]);
        
        this.DayAvailability = this.tb.classViewer("DayAvailability", [
          "date","busySlots","confidence",
        ]);
