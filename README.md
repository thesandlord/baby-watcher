...
Firebase Auth + Firestore hold household data. Calendar screenshot OCR runs in a secure Cloud Function using Gemini 3.5 Flash-Lite with BAML structured outputs. Schedule generation stays deterministic in the shared package / browser.
...
- Secure Cloud Function OCR (Gemini 3.5 Flash-Lite + BAML)
